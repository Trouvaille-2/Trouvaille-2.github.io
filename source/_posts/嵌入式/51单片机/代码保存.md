...
一些没有分类的知识：
![数据类型](/img/51单片机/数据类型.webp)

## 点亮led灯

![led灯模块](/img/51单片机/led.webp)
...
0x是一个前缀，代表后面数字为十六进制
![2025-9-8](/img/51单片机/2025-9-8.webp)
...
![独立按键电路图](/img/51单片机/独立按键电路图.webp)
...
## 数码管
![译码器](/img/51单片机/138.webp)
![数码管](/img/51单片机/数码管.webp)
